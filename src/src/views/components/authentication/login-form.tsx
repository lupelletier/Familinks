...
export default function LoginForm(): any{
    return (
        <form class="login-form" hx-post="/auth/login" hx-target="#home-guest" hx-swap="innerHTML" hx-push-url="true" hx-indicator="#loading-indicator">
            <div class={'space-y-4'}>
                <div>
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" placeholder="Password" required
                           class="appearance-none border rounded-l border-solid-dark w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
